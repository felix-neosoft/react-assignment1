    ...
    render(){
        return (
            <><div className="main-content-box">
                <div className="box">
                    <img className="wall-img" src="images/25636.jpg" width="390" height="290" />
                ...
                <div className="box">
                    <img className="wall-img" src="images/25638.jpg" width="390" height="290" />
                ...
                <div className="box">
                    <img className="wall-img" src="images/25640.jpg" width="390" height="290" />
